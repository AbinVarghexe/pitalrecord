...
export function FeaturesSection() {
  return (
    <section id="features" className="w-full py-24 sm:py-32 relative z-10 flex flex-col items-center justify-center px-4 sm:px-8 mt-16 font-sans">
      ...
      <div className="w-full max-w-[1400px] relative isolate px-8 sm:px-16 md:px-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start relative z-10">
          ...
          <div className="relative h-[500px] lg:h-[600px] w-full mt-12 lg:mt-0 flex items-center justify-center">
            
            {/* Card 1: Smart Extraction (Back left - matches Card 1 style) */}
            <div className="absolute w-[60%] sm:w-[50%] aspect-square bg-blue-50/50 backdrop-blur-sm border border-white/40 rounded-3xl -rotate-6 -translate-x-12 -translate-y-12 shadow-xl overflow-hidden transition-all duration-700 hover:-translate-y-16 hover:-rotate-12 group z-10 flex flex-col items-center justify-center p-6 text-center">
              <div className="w-16 h-16 rounded-2xl bg-blue-500/10 flex items-center justify-center mb-4 transition-transform group-hover:scale-110">
              ...
              <h3 className="font-bold text-slate-900 mb-1">Smart - OCR</h3>
              <p className="text-[13px] text-slate-500 leading-relaxed font-medium">
                Instant digitisation of handwritten prescriptions.
              </p>
            </div>

            {/* Card 2: Secure Timeline (Back right - matches Card 2 style) */}
            <div className="absolute w-[60%] sm:w-[50%] aspect-square bg-indigo-50/50 backdrop-blur-sm border border-white/40 rounded-3xl rotate-6 translate-x-12 translate-y-4 shadow-xl overflow-hidden transition-all duration-700 hover:-translate-y-2 hover:rotate-12 group z-20 flex flex-col items-center justify-center p-6 text-center">
              <div className="w-16 h-16 rounded-2xl bg-indigo-500/10 flex items-center justify-center mb-4 transition-transform group-hover:scale-110">
              ...
              <h3 className="font-bold text-slate-900 mb-1">Secure - History</h3>
              <p className="text-[13px] text-slate-500 leading-relaxed font-medium">
                End-to-end encrypted medical timeline.
              </p>
            </div>

            {/* Card 3: Doctor Sync (Front center - matches Card 3 style) */}
            <div className="absolute w-[55%] sm:w-[45%] aspect-square bg-white border border-gray-100 rounded-3xl shadow-2xl translate-y-20 overflow-hidden transition-all duration-700 hover:-translate-y-4 group z-30 flex flex-col items-center justify-center p-6 text-center">
              <div className="w-16 h-16 rounded-2xl bg-blue-500/10 flex items-center justify-center mb-4 transition-transform group-hover:scale-110">
                <svg className="w-10 h-10 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
                </svg>
              </div>
              <h3 className="font-bold text-slate-900 mb-1">Clinical - Sync</h3>
              <p className="text-[13px] text-slate-500 leading-relaxed font-medium">
                Secure sharing with clinician access keys.
              </p>
            </div>
